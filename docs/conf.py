# -*- coding: utf-8 -*-
#
# ZK Watcher documentation build configuration file, created by
# sphinx-quickstart on Mon Dec 14 09:29:44 2015.
#
...
import zk_watcher
from zk_watcher import version as zk_watcher_version
...
project = u'ZK Watcher'
copyright = u'2015, Nextdoor Engineering'
...
version = release = zk_watcher_version
...
modindex_common_prefix = ['zk_watcher.']
...
htmlhelp_basename = 'ZKWatcherdoc'
...
latex_documents = [
  (master_doc, 'ZKWatcher.tex', u'ZK Watcher Documentation',
   u'Nextdoor Engineering', 'manual'),
]
...
man_pages = [
    (master_doc, 'zkwatcher', u'ZK Watcher Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ZKWatcher', u'ZK Watcher Documentation',
   author, 'ZKWatcher', 'One line description of project.',
   'Miscellaneous'),
]
